...
from gedcom_parser import GedcomError, GedcomParser, GedcomRecord, Encoding, Version
...
0 TRLR"""
    ...
    try:
        ...
        assert note_records[0].value == "This is a note that continues on the same line\nAnd this is on a new line"
